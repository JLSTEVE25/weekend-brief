...
4.  **Section 3 — "Your Weekend" Timeline** (always visible, below weather)
    ...
    - "Nothing planned" / "All day free" lines: lighter color with ✨ —
      these correspond to open windows and are the visual hooks for suggestions
    - If CALENDAR EVENTS is empty (secrets not yet set), show placeholder text:
      "Calendar sync coming soon" in a soft gray — do not error

5.  **Tab bar — 2 tabs:** "Suggestions" | "Coming Up"
    The calendar timeline (Section 3) always sits ABOVE the tab bar.
